  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: '16px', fontWeight: 600 }}>{bio.name.split(' · ')[0]}</div>
        <div style={{ fontSize: '12px', opacity: 0.75, fontStyle: 'italic', marginTop: '5px' }}>{bio.tagline}</div>
        <div style={{ fontSize: '10px', opacity: 0.4, marginTop: '8px' }}>hover to read more →</div>
      </button>
